  ...
  <div className={css.skillPage}>
    ...
    <div className={css.skillPage_context}>
      ...
      <div className={css.skillPage_context_description}>
        ...
        <p>现在我能自己搭建前端工程化开发环境，使用html/css(less)构建web应用界面，或者使用React、Redux、React-router等框架/工具构建复杂应用。同时，也不同程度地学习了数据结构与算法、网络过程、java后端等知识。</p>
        <p>前端发展很快，在这个时间点选择前端，就是选择不断地学习。</p>
      </div>
    </div>
  </div>
);
